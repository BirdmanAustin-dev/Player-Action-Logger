...
```text
target/PlayerActionLogger-Paper-0.8.1.jar
```
...
Version 0.8.1 includes the dashboard with day-by-day historical moderation intelligence in addition to the live activity, combat, alerts, and insights views.
